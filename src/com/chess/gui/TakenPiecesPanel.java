...
public class TakenPiecesPanel extends JPanel{
    ...
    private static final Color PANEL_COLOR = Color.decode("0xF5F5DC");
    ...
    public void redo(final Table.MoveLog moveLog){
        ...
        for(final Piece takenPiece: whiteTakenPieces){
            try{
                final BufferedImage image = ImageIO.read(new File("JChess/art/pieces/plain/" + takenPiece.getPieceAlliance().toString().substring(0,1) + "" + takenPiece.toString() + ".gif"));
