   ...
   protected  final int destinationCoordinate;
    ...
    public static final class MajorMove extends Move{
        ...
        public String toString(){
            return movedPiece.getPieceType().toString()+BoardUtils.getCoordinateAtPosition(this.destinationCoordinate);
        }
    ...
    public static class AttackMove extends Move{
        ...
        @Override
        public String toString(){
            return movedPiece.getPieceType().toString()+"x"+BoardUtils.getCoordinateAtPosition(this.destinationCoordinate);
        }
    ...
    public static final class PawnEnPassantAttackMove extends PawnAttackMove{
        public PawnEnPassantAttackMove(final Board board,final Piece movedPiece,final int destinationCoordinate,Piece attackedPiece){
            ...
            this.attackedPiece=board.getEnPassantPawn();
        }
        @Override
        public Board execute(){
            final Builder builder=new Builder();
